...
var cm = /*@__PURE__*/getDefaultExportFromCjs(codemirrorExports);

/* lib\cm.svelte generated by Svelte v3.59.1 */
...
function instance$1($$self, $$props, $$invalidate) {
	const omit_props_names = ["options","value","editor"];
	...
	component_subscribe($$self, inputValue, value => $$invalidate(7, $inputValue = value));
	const editor = () => input;

	const init = () => {
		$$invalidate(6, input = cm(container, {}));
		input.setSize("100%", "100%");

		requestAnimationFrame(() => {
			input.setValue(value);
			input.on("change", () => set_store_value(inputValue, $inputValue = input.getValue(), $inputValue));
		});
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$inputValue*/ 128) {
			$$invalidate(3, value = $inputValue);
		}

		if ($$self.$$.dirty & /*$inputValue, value, input*/ 200) {
			if ($inputValue !== value) {
				input.setValue(value);
			}
		}
		...
		if ($$self.$$.dirty & /*input, options*/ 80) {
			if (input !== null) {
...
class Cm extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { options: 4, value: 3, editor: 5 });
	}
...
var testCode = `import rand from "./rand.mjs"
...
/* test\app.svelte generated by Svelte v3.59.1 */
...
function create_fragment(ctx) {
	...
	function codemirror_value_binding(value) {
		/*codemirror_value_binding*/ ctx[3](value);
	}
	...
	codemirror = new Cm({ props: codemirror_props });
	binding_callbacks.push(() => bind(codemirror, 'value', codemirror_value_binding));
	codemirror.$on("ready", /*ready*/ ctx[1]);
...
function instance($$self, $$props, $$invalidate) {
	...
	return [value, ready, options, codemirror_value_binding];
}
